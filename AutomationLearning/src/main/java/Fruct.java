public class Fruct {
    ...
    private String culoareFruct;
    private String textureFruct;
    private String gustFruct;
    private String mirosFruct;
    private String greutateFruct;

    public void setNumeFruct(String mar){
        this.numeFruct = mar;
    }
